...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        MSE (Mean Square Error) : <?= round(array_sum($f->e2) / count($f->e2), 2) ?><br />
        RMSE (Root Mean Square Error) : <?= round(sqrt(array_sum($f->e2) / count($f->e2)), 2) ?><br />
        MAD (Mean Absolute Deviation) : <?= round(array_sum($f->e_abs) / count($f->e_abs), 2) ?><br />
